...
public class NutrientController : MonoBehaviour
{
    ...
    GameObject Gcarbohydrates;
    GameObject Gprotein;
    GameObject Gfats;
    GameObject Gsugar;
    GameObject GdietaryFiber;
    GameObject Gvitamins;
    ...
    //ui에 영양소 정보 출력
    //private void updatenutritiontext()
    //{
    //    if (nutritiontext != null)
    //    {
    //        nutritiontext.text = "carbs: " + carbohydrates + "\n" +
    //                             "protein: " + protein + "\n" +
    //                             "fat: " + fat + "\n" +
    //                             "sugar: " + sugar + "\n" +
    //                             "fiber: " + dietaryfiber + "\n" +
