...
public class PlayerMoveController : MonoBehaviour
{
    ...
    void HangingMode() // 큐브 매달리기 & 매달린 상태에서 이동
    {
        ...
        if (Physics.Raycast(forwardRay, out forwarhit, 0.8f) && forwarhit.collider.CompareTag("Cube"))
        {
            ...
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHangingMoving && Physics.Raycast(r_Ray, out r_Hit, 0.8f) && r_Hit.collider.CompareTag("Cube"))
                {
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHangingMoving && Physics.Raycast(l_Ray, out l_Hit, 0.8f) && l_Hit.collider.CompareTag("Cube"))
                {
            ...
            {              
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHangingMoving && Physics.Raycast(l_Ray, out l_Hit, 0.8f) && l_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = l_Hit.collider.gameObject;
                    StartCoroutine(MoveLeftHangingOnCube());
                }
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHangingMoving && Physics.Raycast(r_Ray, out r_Hit, 0.8f) && r_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = r_Hit.collider.gameObject;
                    StartCoroutine(MoveRightHangingOnCube());
                }
            ...
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHangingMoving && Physics.Raycast(b_Ray, out b_Hit, 0.8f) && b_Hit.collider.CompareTag("Cube"))
                {
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHangingMoving && Physics.Raycast(f_Ray, out f_Hit, 0.8f) && f_Hit.collider.CompareTag("Cube"))
                {
            ...
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHangingMoving && Physics.Raycast(f_Ray, out f_Hit, 0.8f) && f_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = f_Hit.collider.gameObject;
                    StartCoroutine(MoveLeftHangingOnCube());
                }
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHangingMoving && Physics.Raycast(b_Ray, out b_Hit, 0.8f) && b_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = b_Hit.collider.gameObject;
                    StartCoroutine(MoveRightHangingOnCube());
                }
