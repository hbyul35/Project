...
public class PlayerMoveController : MonoBehaviour
{
    ...
    void HangingMode() // 큐브 매달리기 & 매달린 상태에서 이동
    {
        ...
        if (Input.GetKey(KeyCode.G) && Input.GetKeyDown(KeyCode.W) && Physics.Raycast(downwardRay, out downwarhit, 0.5f) && downwarhit.collider.CompareTag("Cube") && !isHoldMode)
        {
        ...
        else if(Input.GetKey(KeyCode.G) && Input.GetKeyDown(KeyCode.S) && Physics.Raycast(downwardRay, out downwarhit, 0.5f) && downwarhit.collider.CompareTag("Cube") && !isHoldMode)
        {
        ...
        else if (Input.GetKey(KeyCode.G) && Input.GetKeyDown(KeyCode.A) && Physics.Raycast(downwardRay, out downwarhit, 0.5f) && downwarhit.collider.CompareTag("Cube") && !isHoldMode)
        {
        ...
        else if (Input.GetKey(KeyCode.G) && Input.GetKeyDown(KeyCode.D) && Physics.Raycast(downwardRay, out downwarhit, 0.5f) && downwarhit.collider.CompareTag("Cube") && !isHoldMode)
        {
        ...
        if (Physics.Raycast(forwardRay, out forwarhit, 0.8f) && forwarhit.collider.CompareTag("Cube"))
        {
            ...
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHoldMoving && Physics.Raycast(r_Ray, out r_Hit, 0.8f) && r_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = r_Hit.collider.gameObject;
                    StartCoroutine(MoveLeftHangingOnCube());
                }
                else if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHoldMoving && 
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHoldMoving && Physics.Raycast(l_Ray, out l_Hit, 0.8f) && l_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = l_Hit.collider.gameObject;
                    StartCoroutine(MoveRightHangingOnCube());
                }
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHoldMoving && 
            ...
            {              
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHoldMoving && Physics.Raycast(l_Ray, out l_Hit, 0.8f) && l_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = l_Hit.collider.gameObject;
                    StartCoroutine(MoveLeftHangingOnCube());
                }
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHoldMoving && Physics.Raycast(r_Ray, out r_Hit, 0.8f) && r_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = r_Hit.collider.gameObject;
                    StartCoroutine(MoveRightHangingOnCube());
                }
                ...
                {
                    StartCoroutine(RotateRightOnCube(targetCube));
                    //StartCoroutine(RotateRightOnCube2(targetCube));
                }
            }
            //right
            if (Physics.Raycast(r_Ray, out r_Hit, 0.8f) && r_Hit.collider.CompareTag("player"))
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHoldMoving && Physics.Raycast(b_Ray, out b_Hit, 0.8f) && b_Hit.collider.CompareTag("Cube"))
                {
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHoldMoving && Physics.Raycast(f_Ray, out f_Hit, 0.8f) && f_Hit.collider.CompareTag("Cube"))
                {
            ...
            {
                if (Input.GetKeyDown(KeyCode.A) && isHoldMode && !isHoldMoving && Physics.Raycast(f_Ray, out f_Hit, 0.8f) && f_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = f_Hit.collider.gameObject;
                    StartCoroutine(MoveLeftHangingOnCube());
                }
                ...
                if (Input.GetKeyDown(KeyCode.D) && isHoldMode && !isHoldMoving && Physics.Raycast(b_Ray, out b_Hit, 0.8f) && b_Hit.collider.CompareTag("Cube"))
                {
                    targetCube = b_Hit.collider.gameObject;
                    StartCoroutine(MoveRightHangingOnCube());
                }
            ...
            //    }
            //    if (Input.GetKeyDown(KeyCode.W) && isHoldMode && !isHoldMoving)
            //    {
            //        Debug.Log("HangingDownMovement");
            //        StartCoroutine(MoveUpHangingOnCube());
            ...
            if (isHoldMode && !isHoldMoving && !isHanging && 
    ...
    IEnumerator RotateRightOnCube2(GameObject targetCube)
    {
        isHoldMoving = true; 

        Vector3 start = transform.position;
        Vector3 end = targetCube.transform.position + targetCube.transform.right * 0.8f;
